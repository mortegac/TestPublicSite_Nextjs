...
const CountryMobileSelector = ({ countryToggle, setCountryToggle, activeDocMeta }) => {
  ...
  let uniqueCountries = activeDocMeta.alternateLanguages.filter((elem,index) => activeDocMeta.alternateLanguages.findIndex(obj => obj.lang.slice(-2) === elem.lang.slice(-2)) === index)
  ...
  const filteredCountries = uniqueCountries.filter((item)=>!excludeCountry.includes(item.lang))
